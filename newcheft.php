            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Thêm đầu bếp mới</h5>
                            <?php
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
                                ...
                                $insertNV = $nv->insert_cheft($_POST, $_FILES); // hàm check Name khi submit lên
                            }
                            //
                            if (isset($insertNV)) {
                                echo $insertNV;
                            ...
                            ?>
                            <form class="needs-validation" validate action="newcheft.php" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <select class="input-group-text" name="schechuledefault" id="validationTooltipUsernamePrepend">
                                                    <option></option>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="ghichu" class="form-control" id="validationTooltip03" placeholder="note">
