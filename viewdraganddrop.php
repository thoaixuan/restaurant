                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                ...
                                $cs = new nhanvien();
                                ?>
<h2>Danh sách nhân viên đã set lịch cố định</h2>
                                <div class="row mt-8">
                                    <div class="col" style="margin: 0 0 10px 0;">
                                        <div class="jumbotron">
                                            ...
                                            <ul class="list-group mt-1" id="demo2">
                                                ...
                                                <?php
                                                $get_nv = $cs->GetStaffby("Thứ 2");
                                                if ($get_nv) {
                                                    while ($result = $get_nv->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $result['ten'] ?> (*<?= $result['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="demo3">
                                                ...
                                                <?php
                                                $get_nvt3 = $cs->GetStaffby("Thứ 3");
                                                if ($get_nvt3) {
                                                    while ($resultt3 = $get_nvt3->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultt3['ten'] ?> (*<?= $resultt3['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="demo4">
                                                ...
                                                <?php
                                                $get_nvt4 = $cs->GetStaffby("Thứ 4");
                                                if ($get_nvt4) {
                                                    while ($resultt4 = $get_nvt4->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultt4['ten'] ?> (*<?= $resultt4['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="demo5">
                                                ...
                                                <?php
                                                $get_nvt5 = $cs->GetStaffby("Thứ 5");
                                                if ($get_nvt5) {
                                                    while ($resultt5 = $get_nvt5->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultt5['ten'] ?> (*<?= $resultt5['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="demo6">
                                                ...
                                                <?php
                                                $get_nvt6 = $cs->GetStaffby("Thứ 6");
                                                if ($get_nvt6) {
                                                    while ($resultt6 = $get_nvt6->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultt6['ten'] ?> (*<?= $resultt6['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="demo7">
                                                ...
                                                <?php
                                                $get_nvt7 = $cs->GetStaffby("Thứ 7");
                                                if ($get_nvt7) {
                                                    while ($resultt7 = $get_nvt7->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultt7['ten'] ?> (*<?= $resultt7['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
                                            ...
                                            <ul class="list-group mt-1" id="democn">
                                                ...
                                                <?php
                                                $get_nvcn = $cs->GetStaffby("Chủ nhật");
                                                if ($get_nvcn) {
                                                    while ($resultcn = $get_nvcn->fetch_assoc()) {

                                                ?>
                                                        <li class="list-group-item"><?= $resultcn['ten'] ?> (*<?= $resultcn['chucvu'] ?>)</li>
                                                <?php
                                                    }
                                                } ?>
                                            </ul>
